...
EPISODES = 200000
STORE_PATH = "/home/dawei/highway_project/highway_multitask_action noweight/model"
...
def test():
    agent = DQNAgent(ENV)
    agent.eval()
    agent.load("/home/dawei/highway_project/highway_multitask_action noweight/model/13800")
